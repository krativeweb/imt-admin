module.exports = [
  ...
  /* ================= STATIC PAGES ================= */
  { id: 3, name: "Mandatory Disclosure", icon: "la-building", routePath: "/admin/mandatory-disclosure" },
  { id: 4, name: "About IMT Hyderabad", icon: "la-wallet", routePath: "/admin/about-imt-hyderabad" },
  { id: 5, name: "International Relations", icon: "la-wallet", routePath: "/admin/international-relations" },
  { id: 6, name: "Manage Others", icon: "la-id-badge", routePath: "/admin/others" },
  ...
  /* ================= FACULTY ================= */
  {
    ...
    children: [
      ...
      { id: "7.2", name: "Faculty Details Seo Settings", routePath: "/admin/faculty-details-seo-settings" },
  ...
  /* ================= WORKSHOPS ================= */
  {
    ...
    children: [
      ...
      { id: "10.3", name: "Conference Details", routePath: "/admin/conferences-details" },
    ],
  },
  ...
  /* ================= PLACEMENTS ================= */
  { id: 15, name: "Manage Placement", icon: "la-boxes", routePath: "/admin/placement" },
  ...
  /* ================= STUDENT LIFE ================= */
  {
    ...
    children: [
      ...
      { id: "25.5", name: "Event Calendar", routePath: "/admin/event-calender" },
    ],
  },
