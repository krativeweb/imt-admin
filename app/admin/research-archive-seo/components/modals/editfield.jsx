// app/admin/research-archive/components/modals/ResearchArchiveSeoEditModal.jsx
"use client";

import React, { useState, useEffect } from "react";
import { Editor } from "@tinymce/tinymce-react";

const ResearchArchiveSeoEditModal = ({ show, onClose, field, onSave }) => {
        ...
        <div className="modal-content">
          ...
          <div className="modal-header">
            <h5 className="modal-title fw-bold">
              Edit Research Archive SEO & Banner Content
            </h5>
...
export default ResearchArchiveSeoEditModal;
