...
const Table = () => {
  ...
  const fetchPages = async () => {
    try {
      ...
      // 🔥 PGDM FINANCE API
      const res = await api.get("/api/pgdm-finance");

      // backend returns array
      setData(Array.isArray(res.data) ? res.data : []);
    } catch (error) {
      console.error("Error fetching PGDM Finance:", error);
      setData([]);
    } finally {
      setLoading(false);
    }
