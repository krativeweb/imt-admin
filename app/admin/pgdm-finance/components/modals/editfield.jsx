  ...
  useEffect(() => {
    if (field) {
      setFormData({
        ...
        pgdm_finance: field.pgdm_finance || "",
      ...
      <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="mb-4">
              <label className="form-label fw-semibold">PGDM Finance Content</label>

              <Editor
                apiKey={process.env.NEXT_PUBLIC_TINYMCE_API_KEY_2}
                value={formData.pgdm_finance || ""}
                onEditorChange={(content) =>
                  setFormData((prev) => ({ ...prev, pgdm_finance: content }))
                }
                init={{
                  height: 300,
                  menubar: true,
