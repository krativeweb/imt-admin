  ...
  useEffect(() => {
    if (field) {
      setFormData({
        ...
        internship_program: field.internship_program || "",
        internship_procedure: field.internship_procedure || "",
        student_committees: field.student_committees || "",
        recruiters_guide: field.recruiters_guide || "",
        internship_reports: field.internship_reports || "",
        ...
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title fw-bold">
              Edit Page SEO & Internship Content
            </h5>
            <button
              type="button"
              className="btn-close"
          ...
          <div className="modal-body">
            ...
            <CmsEditor
              value={formData.internship_program}
              onChange={(v) =>
                setFormData((p) => ({ ...p, internship_program: v }))
              }
            />
            ...
            <CmsEditor
              value={formData.internship_procedure}
              onChange={(v) =>
                setFormData((p) => ({ ...p, internship_procedure: v }))
              }
            />
            ...
            <CmsEditor
              value={formData.recruiters_guide}
              onChange={(v) =>
                setFormData((p) => ({ ...p, recruiters_guide: v }))
              }
            />
            ...
            <CmsEditor
              value={formData.internship_reports}
              onChange={(v) =>
                setFormData((p) => ({ ...p, internship_reports: v }))
              }
            />
