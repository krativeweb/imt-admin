...
const EditfieldModal = ({ show, onClose, field, onSave, pageType }) => {
  ...
  /**
   * Handle default data
   * Workshops & Conferences page is FIXED
   */
  useEffect(() => {
    if (pageType === "workshops_conferences") {
      setFormData({
        page_title: "Workshops & Conferences",
  ...
  /**
   * Save with FORCED title & slug
   */
  const handleSave = () => {
    const form = new FormData();

    // Force fixed page values
    if (pageType === "workshops_conferences") {
      form.append("page_title", "Workshops & Conferences");
      form.append("page_slug", "conferences-workshops");
    }
