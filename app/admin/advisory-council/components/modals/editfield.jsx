...
const EditAdvisoryCouncilModal = ({ show, onClose, field, onSave }) => {
  ...
  useEffect(() => {
    if (field) {
      setFormData({
        ...
        image: null, // only if user uploads new image
      });
...
export default EditAdvisoryCouncilModal;
