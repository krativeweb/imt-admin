      ...
      <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div className="modal-content">
          ...
          <div className="modal-body">
           ...
           {formData.page_slug === "annual-events" && (
  <>
    <hr className="my-4" />
    ...
    <div className="mb-5">
      ...
      <div className="row g-2">
        ...
        {formData.gallery_images?.map((img, i) => {
          ...
          return (
            <div key={`existing-${i}`} className="col-3 col-sm-2 col-md-2 col-lg-1">
        ...
        {formData.new_gallery_images?.map((file, i) => (
          <div key={`new-${i}`} className="col-3 col-sm-2 col-md-2 col-lg-1">
            <div className="position-relative rounded overflow-hidden border">
              <img
              ...
              <button
                ...
                onClick={() =>
                  setFormData(prev => ({
                    ...prev,
                    new_gallery_images: prev.new_gallery_images.filter((_, idx) => idx !== i)
                  }))
                }
                title="Remove"
              >
      ...
      {/* Count */}
      {(formData.gallery_images?.length + formData.new_gallery_images?.length) > 0 && (
        <small className="text-muted d-block mt-2">
          Total: {formData.gallery_images.length + formData.new_gallery_images.length} images
