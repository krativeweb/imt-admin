...
const EditHomeConnectModal = ({ show, onClose, field, onSave }) => {
  ...
  useEffect(() => {
    if (field) {
      setFormData({
        title: field.title || "",
        image: null, // only replace if new image selected
...
export default EditHomeConnectModal;
