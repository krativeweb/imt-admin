...
const AddCommitteesImtModal = ({ show, onClose, onSave }) => {
      ...
      <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            {/* CONTENT */}
            <label className="fw-semibold mb-2">Committee Content</label>
            <CmsEditor
            ...
            {/* MAIN IMAGE */}
            <div className="mt-4">
              <label className="fw-semibold">Committee Main Image</label>
              <input
                type="file"
                className="form-control"
                onChange={(e) =>
...
export default AddCommitteesImtModal;
