  ...
  useEffect(() => {
    if (field) {
      setFormData({
        ...
        sponsored_research: field.sponsored_research || "",
        advisory_services: field.advisory_services || "",
      });
    }
  }, [field]);
        ...
        <div className="modal-content">
          ...
          <div className="modal-header">
            <h5 className="modal-title fw-bold">
              Edit Sponsored Research & Advisory Services
            </h5>
          ...
          <div className="modal-body">
            ...
            <div className="mb-4">
              ...
              <Editor
  apiKey={process.env.NEXT_PUBLIC_TINYMCE_API_KEY_2}
  value={formData.sponsored_research}
  init={{
    height: 500,
    menubar: true,
    ...
    content_style: `
      ...
      /* Always show all content inside editor */
      .tab-pane {
...
/>
            ...
            <div className="mb-4">
              ...
              <Editor
  apiKey={process.env.NEXT_PUBLIC_TINYMCE_API_KEY_2}
  value={formData.advisory_services}
  init={{
    height: 500,
    menubar: true,
