...
const EditResearchMagazinesModal = ({ show, onClose, field, onSave }) => {
  ...
  const handleSave = () => {
    ...
    onSave({
      ...field, // keep _id and backend metadata
      ...formData,
    });
        ...
        <div className="modal-content">
          ...
          <div className="modal-header">
            <h5 className="modal-title fw-bold">
              Edit Research Magazine Article
            </h5>
...
export default EditResearchMagazinesModal;
